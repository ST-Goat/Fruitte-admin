...
export const SidebarMenuItem: FC<SidebarMenuItemProps> = forwardRef<unknown, SidebarMenuItemProps>(
  ({ children, className, icon, active, suffix, firstChild, popperArrow, dot, collapsed, ...props }, ref) => {
    const sidebarMenuItemRef: LegacyRef<HTMLLIElement> = (ref as any) || React.createRef<HTMLLIElement>()
